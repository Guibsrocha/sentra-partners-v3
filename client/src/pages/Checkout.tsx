...
export default function Checkout() {
  ...
  const plan = searchParams.get("plan"); // Para planos de assinatura
  ...
  const handleCheckout = async () => {
    ...
    // Se for plano de assinatura, criar conta automaticamente
    if (plan) {
      try {
        ...
        toast.success("Conta criada! Senha enviada por email.");
      } catch (err: any) {
    ...
    // Disparar evento de conversão (AddPaymentInfo)
    if (landingPixels) {
      trackAddPaymentInfo({
