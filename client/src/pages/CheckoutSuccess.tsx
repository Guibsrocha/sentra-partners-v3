...
import { trackPurchase } from "@/services/tracking";
...
export default function CheckoutSuccess() {
  ...
  // Disparar evento de conversão quando pagamento for confirmado
  useEffect(() => {
    if (orderStatus?.status === "finished" && !purchaseTracked && landingPixels) {
      trackPurchase({
        ...
        value: orderStatus.price_amount || 0,
        currency: orderStatus.price_currency?.toUpperCase() || 'USD',
      });
      setPurchaseTracked(true);
    }
  }, [orderStatus, purchaseTracked, landingPixels]);
