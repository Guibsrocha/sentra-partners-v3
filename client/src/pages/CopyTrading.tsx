                ...
                {!copyRelations || copyRelations.length === 0 ? (
                  <div className="text-center py-12 text-muted-foreground">
                    ...
                    <p className="text-sm mt-2">
                      As relações Master/Slave são criadas automaticamente quando os EAs se conectam ao servidor.
                    </p>
                    <p className="text-sm mt-2">
                      Certifique-se de que seus EAs Master e Slave estão rodando e conectados.
                    </p>
                  </div>
                ) : (
