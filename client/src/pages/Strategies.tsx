                    ...
                    return (
                      ...
                      >
                        <div className="flex flex-col h-full justify-between">
                          <span className={`text-xs sm:text-sm md:text-base font-medium ${isToday ? 'text-blue-600 dark:text-blue-400' : ''}`}>
                            {day.getDate()}
                          </span>
                          {hasProfit && (
                            <div className={`font-semibold leading-tight text-sm sm:text-base md:text-lg lg:text-3xl xl:text-4xl 2xl:text-5xl ${profit > 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
